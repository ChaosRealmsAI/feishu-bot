...
src/app/office/local.rs Office API-free command entrypoint and re-exports.
src/app/office/local/ Office local dispatch, list, bootstrap/report dry-run, status, and cleanup helpers.
