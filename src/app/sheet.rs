...
pub(super) fn build_sheet_create_body(args: SheetCreateArgs) -> Result<Value> {
...
pub(super) fn build_sheet_add_body(args: SheetAddArgs) -> Result<Value> {
...
pub(super) fn build_sheet_copy_body(args: SheetCopyArgs) -> Result<Value> {
    if has_json_input(&args.body_json, &args.file, args.stdin) {
        return wrap_sheet_batch_request(
            read_json_value(args.body_json, args.file, args.stdin)?,
            "copySheet",
...
pub(super) fn build_sheet_delete_body(args: SheetDeleteArgs) -> Value {
    json!({
        "requests": [{
...
pub(super) fn build_sheet_update_body(args: SheetUpdateArgs) -> Result<Value> {
    if has_json_input(&args.body_json, &args.file, args.stdin) {
        return wrap_sheet_batch_request(
            read_json_value(args.body_json, args.file, args.stdin)?,
            "updateSheet",
...
pub(super) fn build_sheet_merge_body(args: SheetMergeArgs) -> Result<Value> {
    if has_json_input(&args.body_json, &args.file, args.stdin) {
        return ensure_json_object(
            read_json_value(args.body_json, args.file, args.stdin)?,
            "merge_cells body",
...
pub(super) fn build_sheet_unmerge_body(args: SheetUnmergeArgs) -> Result<Value> {
    if has_json_input(&args.body_json, &args.file, args.stdin) {
        return ensure_json_object(
            read_json_value(args.body_json, args.file, args.stdin)?,
            "unmerge_cells body",
...
pub(super) fn build_sheet_style_body(args: SheetStyleArgs) -> Result<Value> {
...
pub(super) fn build_sheet_values_body(args: SheetValuesWriteArgs) -> Result<Value> {
