...
- `src/app/base.rs` contains Base/Bitable command execution; `src/app/base/`
  contains schema, record, and permission execution, media, reference,
  field/list, search, view, role, and member helper builders.
...
- `src/app/task.rs` contains Task command execution; `src/app/task/` contains
  ...
  collaboration builders plus section/custom-field and reminder/dependency
  relation builders.
